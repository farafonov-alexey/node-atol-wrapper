...
#define LIBFPTR_MODEL_ATOL_STB_6 92
...
enum libfptr_param
{
    ...
    LIBFPTR_PARAM_LAST_SUCCESS_FNM_UPDATE_KEYS_DATE_TIME = 65933,
    LIBFPTR_PARAM_LAST_ATTEMPTION_FNM_UPDATE_KEYS_DATE_TIME = 65934,
    LIBFPTR_PARAM_COUNT_ATTEMPTION_FNM_UPDATE_KEYS = 65935,
};
